    ...
    <div>
      ...
      <div className="profile">
        <div className="sub-profile">
          <h3>Profile</h3>
          <p>
            I am a <i>conscientious person</i> who works hard and pays attention
            to details. I’m <i>flexible</i>, <i>quick to pick up new skills</i>{" "}
            and <i>eager</i> to learn from others. I have experience in customer
            service, negotiation skill and aiming to use my ability and
      ...
      <div className="work-exp">
        <div className="sub-work-exp">
          ...
          <p>
            ...
            as a collector. Altough, I working in the field that different from
            my background in <i>Information System Management</i>, I'm happy
            because i can gain much experience and skills in customer service
            field such as <i>negotation sills</i>,{" "}
            ...
            as Contact Centre Executive for Skim Latihan 1Malaysia program for 1
            year. Now, i'm still working but i'm very excited joined{" "}
            <i>Software Engineer Bootcamp (SEC) 2023</i> to add my value skills
            and experiences to work in the IT industry. If you have any
            questions or would like to learn more about my experience, feel free
            to ask!
          </p>
        </div>
      </div>
      ...
      <div className="interest">
        <div className="sub-interest">
          ...
          <p>
            ...
            Additionally, this activity underscores my commitment to maintaining
            a healthy, balanced lifestyle, fostering both physical and mental
            well-being.
          </p>
        </div>
      </div>
